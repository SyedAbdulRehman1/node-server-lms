...
exports.unpublishChapterHandler = exports.publishChapterHandler = exports.updateChapter = exports.getChapterData = exports.getChapter = void 0;
...
const publishChapterHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { courseId, chapterId } = req.params;
    ...
    try {
        ...
        const publishedChapter = yield chapterService.publishChapter(courseId, chapterId, user.id);
        res.status(200).json({
...
const unpublishChapterHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { courseId, chapterId } = req.params;
    const user = req.user;
    try {
        if (!(user === null || user === void 0 ? void 0 : user.id)) {
        ...
        const chapter = yield chapterService.unpublishChapter(courseId, chapterId, user.id);
        res.status(200).json({
            chapter,
