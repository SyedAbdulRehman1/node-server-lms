...
let MuxService = (() => {
    ...
    let _classThis;
    var MuxService = _classThis = class {
        constructor(prisma) {
            this.prisma = prisma;
        }
        // Upload video to Mux and save video metadata to the database
        uploadVideoToMux(videoUrl, chapterId) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    const muxData = yield this.prisma.muxData.create({
                        data: {
                            chapterId: chapterId,
                            assetId: asset.id,
    ...
    __setFunctionName(_classThis, "MuxService");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        MuxService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return MuxService = _classThis;
})();
