...
exports.unpublishCourseHandler = exports.publishCourseHandler = exports.getChapterHandler = exports.createChapterHandler = exports.uploadFile = exports.getUniqueCourse = exports.GetCourseWithProgress = exports.updateCourse = exports.getCourseDetails = exports.GetCourses = exports.createCourseHandler = void 0;
...
const createCourseHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = req.user;
    try {
        if (!(user === null || user === void 0 ? void 0 : user.id) || user.userType !== "TEACHER") {
            res.status(401).json({ message: "Unauthorized" });
            return;
        }
        const data = yield courseService.createCourse(user.id, createCourseDto);
        const { categoryId, createdAt, description, id, imageUrl, isPublished, price, title, updatedAt, userId, } = data;
        res.status(201).json({
            categoryId,
            createdAt,
            description,
...
const uploadFile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const updatedCourse = yield courseService.updateCourseImage(courseId, userId, fileUrl);
...
const createChapterHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { courseId } = req.params;
...
const getChapterHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { courseId, chapterId } = req.params;
    console.log(courseId, "chadfdf", chapterId);
    try {
        const result = yield courseService.getChapterWithCompletion(courseId, chapterId);
...
const publishCourseHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const publishedCourse = yield courseService.publishCourse(courseId, user.id);
        res.status(200).json({
...
const unpublishCourseHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id: courseId } = req.params;
    const user = req.user;
    try {
        if (!(user === null || user === void 0 ? void 0 : user.id)) {
